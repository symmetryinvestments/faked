...
unittest {
    ...
    auto faker = new Faker_en_au_ocker(23);
	for(int i = 0; i < 30; ++i) {
		assert(!faker.addressBuildingNumber().empty);
		assert(!faker.addressCity().empty);
		assert(!faker.addressCityPrefix().empty);
...
unittest {
    ...
    auto faker = new Faker_en_bork(34);
	for(int i = 0; i < 30; ++i) {
		assert(!faker.addressBuildingNumber().empty);
		assert(!faker.addressCity().empty);
		assert(!faker.addressCityPrefix().empty);
...
unittest {
    ...
    auto faker = new Faker_en_ind(35);
	for(int i = 0; i < 30; ++i) {
		assert(!faker.addressBuildingNumber().empty);
		assert(!faker.addressCity().empty);
		assert(!faker.addressCityPrefix().empty);
...
unittest {
	import faked.faker_nep;
    auto faker = new Faker_nep(38);
	for(int i = 0; i < 30; ++i) {
		assert(!faker.addressBuildingNumber().empty);
		assert(!faker.addressCity().empty);
		assert(!faker.addressCityPrefix().empty);
