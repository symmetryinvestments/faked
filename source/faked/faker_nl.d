...
@safe:
	...
	override string commerceProductDescription() {
		...
		"De indeling van de auto bestaat uit een ontwerp met voorin geplaatste motor",
		"met transmissies van het transaxle-type achter de motor en vierwielaandrijving",
		"Nieuwe ABC 13 9370",
		"13.3",
		"5e Gen CoreA5-8250U",
		"8GB RAM",
		"256GB SSD",
		"krachtige UHD Graphics",
		"OS 10 Home",
		"OS Office A & J 2016",
		...
		"De Apollotech B340 is een betaalbare draadloze muis met betrouwbare connectiviteit",
		"een batterijlevensduur van 12 maanden en een modern ontwerp",
		"De Nagasaki Lander is de merknaam van verschillende series Nagasaki-sportmotoren",
		"die begon met de ABC800J uit 1984",
		...
		"Andy-schoenen zijn ontworpen om zowel duurzaamheid als trends in gedachten te houden",
		"het meest stijlvolle assortiment schoenen en sandalen"
		];
		return choice(data, this.rnd);
	}
