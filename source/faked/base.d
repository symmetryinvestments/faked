...
;
	...
	Currency financeCurrency() {
		...
		Currency("Venezuelan bolívar", "VES", "Bs"),
		Currency("Dong", "VND", "₫"),
		Currency("Vatu", "VUV", ""),
		Currency("Tala", "WST", ""),
	...
	string personBioPattern() {
		final switch(uniform(0, 15, this.rnd)) {
			...
			case 1: return personBioPart();
			case 2: return personBioPart();
			case 3: return personBioPart();
			case 4: return personBioPart();
			case 5: return personBioPart();
			case 6: return personBioPart();
			case 7: return personBioPart();
			case 8: return personBioPart() ~ " " ~ internetEmoji();
			case 9: return wordNoun() ~ " " ~ personBioSupporter();
			case 10: return wordNoun() ~ " " ~ personBioSupporter() ~ "  " ~ internetEmoji();
			case 11: return wordNoun() ~ " " ~ personBioSupporter();
			case 12: return personBioPart();
			case 13: return wordNoun() ~ " " ~ personBioSupporter();
			case 14: return personBioPart() ~ " " ~ internetEmoji();
		}
	}
	...
	string personName() {
		final switch(uniform(0, 15, this.rnd)) {
			...
			case 1: return "weight: 49 }";
			case 2: return "{";
			case 3: return "value: '" ~ personPrefix() ~ " " ~ personFirstName() ~ " " ~ personLastName();
			case 4: return "weight: 7";
			case 5: return "}";
			case 6: return "{";
			case 7: return "value: '" ~ personFirstName() ~ " " ~ personLastName() ~ " " ~ personSuffix();
			case 8: return "weight: 7";
			case 9: return "}";
			case 10: return "{";
			case 11: return "value:";
			case 12: return personPrefix() ~ " " ~ personFirstName() ~ " " ~ personLastName() ~ " " ~ personSuffix();
			case 13: return "weight: 1";
			case 14: return "}";
		}
	}
