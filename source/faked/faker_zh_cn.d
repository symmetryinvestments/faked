...
@safe:
	...
	override Currency financeCurrency() {
		final switch(uniform(0, 155, this.rnd)) {
			...
			case 3: return Currency(q"{亚美尼亚德拉姆}", q"{AMD}", q"{}");
			case 4: return Currency(q"{荷属安的列斯盾}", q"{ANG}", q"{ƒ}");
			case 5: return Currency(q"{宽扎}", q"{AOA}", q"{}");
			case 6: return Currency(q"{阿根廷比索}", q"{ARS}", q"{$}");
			case 7: return Currency(q"{澳大利亚元}", q"{AUD}", q"{$}");
			case 8: return Currency(q"{阿鲁巴弗罗林}", q"{AWG}", q"{ƒ}");
			case 9: return Currency(q"{阿塞拜疆马纳特}", q"{AZN}", q"{ман}");
			case 10: return Currency(q"{可兑换马克}", q"{BAM}", q"{KM}");
			case 11: return Currency(q"{巴巴多斯元}", q"{BBD}", q"{$}");
			case 12: return Currency(q"{孟加拉塔卡}", q"{BDT}", q"{}");
			case 13: return Currency(q"{保加利亚列弗}", q"{BGN}", q"{лв}");
			case 14: return Currency(q"{巴林第纳尔}", q"{BHD}", q"{}");
			case 15: return Currency(q"{布隆迪法郎}", q"{BIF}", q"{}");
			case 16: return Currency(q"{百慕大元（通常称为百慕大元）}", q"{BMD}", q"{$}");
			case 17: return Currency(q"{文莱元}", q"{BND}", q"{$}");
			case 18: return Currency(q"{玻利维亚诺}", q"{BOB}", q"{Bs}");
			case 19: return Currency(q"{巴西雷亚尔}", q"{BRL}", q"{R$}");
			case 20: return Currency(q"{巴哈马元}", q"{BSD}", q"{$}");
			case 21: return Currency(q"{普拉}", q"{BWP}", q"{P}");
			case 22: return Currency(q"{白俄罗斯卢布}", q"{BYN}", q"{Rbl}");
			case 23: return Currency(q"{伯利兹元}", q"{BZD}", q"{BZ$}");
			case 24: return Currency(q"{加拿大元}", q"{CAD}", q"{$}");
			case 25: return Currency(q"{刚果法郎}", q"{CDF}", q"{}");
			case 26: return Currency(q"{瑞士法郎}", q"{CHF}", q"{CHF}");
			case 27: return Currency(q"{智利比索}", q"{CLP}", q"{$}");
			case 28: return Currency(q"{人民币}", q"{CNY}", q"{¥}");
			case 29: return Currency(q"{哥伦比亚比索}", q"{COP}", q"{$}");
			case 30: return Currency(q"{哥斯达黎加科朗}", q"{CRC}", q"{₡}");
			case 31: return Currency(q"{古巴比索}", q"{CUP}", q"{₱}");
			case 32: return Currency(q"{佛得角埃斯库多}", q"{CVE}", q"{}");
			case 33: return Currency(q"{捷克克朗}", q"{CZK}", q"{Kč}");
			case 34: return Currency(q"{吉布提法郎}", q"{DJF}", q"{}");
			case 35: return Currency(q"{丹麦克朗}", q"{DKK}", q"{kr}");
			case 36: return Currency(q"{多米尼加比索}", q"{DOP}", q"{RD$}");
			case 37: return Currency(q"{阿尔及利亚第纳尔}", q"{DZD}", q"{}");
			case 38: return Currency(q"{埃及镑}", q"{EGP}", q"{£}");
			case 39: return Currency(q"{纳克法}", q"{ERN}", q"{}");
			case 40: return Currency(q"{埃塞俄比亚比尔}", q"{ETB}", q"{}");
			case 41: return Currency(q"{欧元}", q"{EUR}", q"{€}");
			case 42: return Currency(q"{斐济元}", q"{FJD}", q"{$}");
			case 43: return Currency(q"{福克兰群岛镑}", q"{FKP}", q"{£}");
			case 44: return Currency(q"{英镑}", q"{GBP}", q"{£}");
			case 45: return Currency(q"{格鲁吉亚拉里}", q"{GEL}", q"{}");
			case 46: return Currency(q"{塞地}", q"{GHS}", q"{}");
			case 47: return Currency(q"{直布罗陀镑}", q"{GIP}", q"{£}");
			case 48: return Currency(q"{达尔西}", q"{GMD}", q"{}");
			case 49: return Currency(q"{几内亚法郎}", q"{GNF}", q"{}");
			case 50: return Currency(q"{格查尔}", q"{GTQ}", q"{Q}");
			case 51: return Currency(q"{圭亚那元}", q"{GYD}", q"{$}");
			case 52: return Currency(q"{港元}", q"{HKD}", q"{$}");
			case 53: return Currency(q"{伦皮拉}", q"{HNL}", q"{L}");
			case 54: return Currency(q"{古德}", q"{HTG}", q"{}");
			case 55: return Currency(q"{福林特}", q"{HUF}", q"{Ft}");
			case 56: return Currency(q"{印度尼西亚卢比}", q"{IDR}", q"{Rp}");
			case 57: return Currency(q"{新以色列谢克尔}", q"{ILS}", q"{₪}");
			case 58: return Currency(q"{不丹努扎姆}", q"{BTN}", q"{Nu}");
			case 59: return Currency(q"{印度卢比}", q"{INR}", q"{₹}");
			case 60: return Currency(q"{伊拉克第纳尔}", q"{IQD}", q"{}");
			case 61: return Currency(q"{伊朗里亚尔}", q"{IRR}", q"{﷼}");
			case 62: return Currency(q"{冰岛克朗}", q"{ISK}", q"{kr}");
			case 63: return Currency(q"{牙买加元}", q"{JMD}", q"{J$}");
			case 64: return Currency(q"{约旦第纳尔}", q"{JOD}", q"{}");
			case 65: return Currency(q"{日元}", q"{JPY}", q"{¥}");
			case 66: return Currency(q"{肯尼亚先令}", q"{KES}", q"{}");
			case 67: return Currency(q"{吉尔吉斯斯坦索姆}", q"{KGS}", q"{лв}");
			case 68: return Currency(q"{瑞尔}", q"{KHR}", q"{៛}");
			case 69: return Currency(q"{科摩罗法郎}", q"{KMF}", q"{}");
			case 70: return Currency(q"{朝鲜圆}", q"{KPW}", q"{₩}");
			case 71: return Currency(q"{韩元}", q"{KRW}", q"{₩}");
			case 72: return Currency(q"{科威特第纳尔}", q"{KWD}", q"{}");
			case 73: return Currency(q"{开曼群岛元}", q"{KYD}", q"{$}");
			case 74: return Currency(q"{坚戈}", q"{KZT}", q"{лв}");
			case 75: return Currency(q"{基普}", q"{LAK}", q"{₭}");
			case 76: return Currency(q"{黎巴嫩镑}", q"{LBP}", q"{£}");
			case 77: return Currency(q"{斯里兰卡卢比}", q"{LKR}", q"{₨}");
			case 78: return Currency(q"{利比里亚元}", q"{LRD}", q"{$}");
			case 79: return Currency(q"{利比亚第纳尔}", q"{LYD}", q"{}");
			case 80: return Currency(q"{摩洛哥迪拉姆}", q"{MAD}", q"{}");
			case 81: return Currency(q"{摩尔多瓦列伊}", q"{MDL}", q"{}");
			case 82: return Currency(q"{马达加斯加阿里亚里}", q"{MGA}", q"{}");
			case 83: return Currency(q"{马其顿代纳尔}", q"{MKD}", q"{ден}");
			case 84: return Currency(q"{缅甸元}", q"{MMK}", q"{}");
			case 85: return Currency(q"{图格里克}", q"{MNT}", q"{₮}");
			case 86: return Currency(q"{澳门元}", q"{MOP}", q"{}");
			case 87: return Currency(q"{乌吉亚}", q"{MRU}", q"{}");
			case 88: return Currency(q"{毛里求斯卢比}", q"{MUR}", q"{₨}");
			case 89: return Currency(q"{拉菲亚}", q"{MVR}", q"{}");
			case 90: return Currency(q"{克瓦查}", q"{MWK}", q"{}");
			case 91: return Currency(q"{墨西哥比索}", q"{MXN}", q"{$}");
			case 92: return Currency(q"{马来西亚林吉特}", q"{MYR}", q"{RM}");
			case 93: return Currency(q"{莫桑比克梅蒂卡尔}", q"{MZN}", q"{MT}");
			case 94: return Currency(q"{奈拉}", q"{NGN}", q"{₦}");
			case 95: return Currency(q"{科多巴金科多巴}", q"{NIO}", q"{C$}");
			case 96: return Currency(q"{挪威克朗}", q"{NOK}", q"{kr}");
			case 97: return Currency(q"{尼泊尔卢比}", q"{NPR}", q"{₨}");
			case 98: return Currency(q"{新西兰元}", q"{NZD}", q"{$}");
			case 99: return Currency(q"{阿曼里亚尔}", q"{OMR}", q"{﷼}");
			case 100: return Currency(q"{巴尔博亚}", q"{PAB}", q"{B/.}");
			case 101: return Currency(q"{秘鲁新索尔}", q"{PEN}", q"{S/.}");
			case 102: return Currency(q"{基纳}", q"{PGK}", q"{}");
			case 103: return Currency(q"{菲律宾比索}", q"{PHP}", q"{Php}");
			case 104: return Currency(q"{巴基斯坦卢比}", q"{PKR}", q"{₨}");
			case 105: return Currency(q"{兹罗提}", q"{PLN}", q"{zł}");
			case 106: return Currency(q"{巴拉圭瓜拉尼}", q"{PYG}", q"{Gs}");
			case 107: return Currency(q"{卡塔尔里亚尔}", q"{QAR}", q"{﷼}");
			case 108: return Currency(q"{新卢}", q"{RON}", q"{lei}");
			case 109: return Currency(q"{塞尔维亚第纳尔}", q"{RSD}", q"{Дин.}");
			case 110: return Currency(q"{俄罗斯卢布}", q"{RUB}", q"{руб}");
			case 111: return Currency(q"{卢旺达法郎}", q"{RWF}", q"{}");
			case 112: return Currency(q"{沙特里亚尔}", q"{SAR}", q"{﷼}");
			case 113: return Currency(q"{所罗门群岛元}", q"{SBD}", q"{$}");
			case 114: return Currency(q"{塞舌尔卢比}", q"{SCR}", q"{₨}");
			case 115: return Currency(q"{苏丹镑}", q"{SDG}", q"{}");
			case 116: return Currency(q"{瑞典克朗}", q"{SEK}", q"{kr}");
			case 117: return Currency(q"{新加坡元}", q"{SGD}", q"{$}");
			case 118: return Currency(q"{圣赫勒拿镑}", q"{SHP}", q"{£}");
			case 119: return Currency(q"{利昂}", q"{SLE}", q"{}");
			case 120: return Currency(q"{索马里先令}", q"{SOS}", q"{S}");
			case 121: return Currency(q"{苏里南元}", q"{SRD}", q"{$}");
			case 122: return Currency(q"{南苏丹镑}", q"{SSP}", q"{}");
			case 123: return Currency(q"{多布拉}", q"{STN}", q"{Db}");
			case 124: return Currency(q"{叙利亚镑}", q"{SYP}", q"{£}");
			case 125: return Currency(q"{利兰吉尼}", q"{SZL}", q"{}");
			case 126: return Currency(q"{泰铢}", q"{THB}", q"{฿}");
			case 127: return Currency(q"{索莫尼}", q"{TJS}", q"{}");
			case 128: return Currency(q"{马纳特}", q"{TMT}", q"{}");
			case 129: return Currency(q"{突尼斯第纳尔}", q"{TND}", q"{}");
			case 130: return Currency(q"{帕安加}", q"{TOP}", q"{}");
			case 131: return Currency(q"{土耳其里拉}", q"{TRY}", q"{₺}");
			case 132: return Currency(q"{特立尼达和多巴哥元}", q"{TTD}", q"{TT$}");
			case 133: return Currency(q"{新台币}", q"{TWD}", q"{NT$}");
			case 134: return Currency(q"{坦桑尼亚先令}", q"{TZS}", q"{}");
			case 135: return Currency(q"{格里夫尼亚}", q"{UAH}", q"{₴}");
			case 136: return Currency(q"{乌干达先令}", q"{UGX}", q"{}");
			case 137: return Currency(q"{美元}", q"{USD}", q"{$}");
			case 138: return Currency(q"{乌拉圭比索}", q"{UYU}", q"{$U}");
			case 139: return Currency(q"{乌兹别克索姆}", q"{UZS}", q"{лв}");
			case 140: return Currency(q"{委内瑞拉玻利瓦尔}", q"{VES}", q"{Bs}");
			case 141: return Currency(q"{越南盾}", q"{VND}", q"{₫}");
			case 142: return Currency(q"{瓦图}", q"{VUV}", q"{}");
			case 143: return Currency(q"{塔拉}", q"{WST}", q"{}");
			case 144: return Currency(q"{科姆罗尔法郎}", q"{XAF}", q"{}");
			case 145: return Currency(q"{银}", q"{XAG}", q"{XAG}");
			case 146: return Currency(q"{金}", q"{XAU}", q"{XAU}");
			case 147: return Currency(q"{东加勒比元}", q"{XCD}", q"{$}");
			case 148: return Currency(q"{特别提款权}", q"{XDR}", q"{XDR}");
			case 149: return Currency(q"{中非金融合作法郎}", q"{XOF}", q"{}");
			case 150: return Currency(q"{波利尼西亚法郎}", q"{XPF}", q"{}");
			case 151: return Currency(q"{也门里亚尔}", q"{YER}", q"{﷼}");
	...
	override ChemicalElement scienceChemicalElement() {
		final switch(uniform(0, 118, this.rnd)) {
			...
			case 3: return ChemicalElement(q"{Be}", q"{铍}", 4);
			case 4: return ChemicalElement(q"{B}", q"{硼}", 5);
			case 5: return ChemicalElement(q"{C}", q"{碳}", 6);
			case 6: return ChemicalElement(q"{N}", q"{氮}", 7);
			case 7: return ChemicalElement(q"{O}", q"{氧}", 8);
			case 8: return ChemicalElement(q"{F}", q"{氟}", 9);
			case 9: return ChemicalElement(q"{Ne}", q"{氖}", 10);
			case 10: return ChemicalElement(q"{Na}", q"{钠}", 11);
			case 11: return ChemicalElement(q"{Mg}", q"{镁}", 12);
			case 12: return ChemicalElement(q"{Al}", q"{铝}", 13);
			case 13: return ChemicalElement(q"{Si}", q"{硅}", 14);
			case 14: return ChemicalElement(q"{P}", q"{磷}", 15);
			case 15: return ChemicalElement(q"{S}", q"{硫}", 16);
			case 16: return ChemicalElement(q"{Cl}", q"{氯}", 17);
			case 17: return ChemicalElement(q"{Ar}", q"{氩}", 18);
			case 18: return ChemicalElement(q"{K}", q"{钾}", 19);
			case 19: return ChemicalElement(q"{Ca}", q"{钙}", 20);
			case 20: return ChemicalElement(q"{Sc}", q"{钪}", 21);
			case 21: return ChemicalElement(q"{Ti}", q"{钛}", 22);
			case 22: return ChemicalElement(q"{V}", q"{钒}", 23);
			case 23: return ChemicalElement(q"{Cr}", q"{铬}", 24);
			case 24: return ChemicalElement(q"{Mn}", q"{锰}", 25);
			case 25: return ChemicalElement(q"{Fe}", q"{铁}", 26);
			case 26: return ChemicalElement(q"{Co}", q"{钴}", 27);
			case 27: return ChemicalElement(q"{Ni}", q"{镍}", 28);
			case 28: return ChemicalElement(q"{Cu}", q"{铜}", 29);
			case 29: return ChemicalElement(q"{Zn}", q"{锌}", 30);
			case 30: return ChemicalElement(q"{Ga}", q"{镓}", 31);
			case 31: return ChemicalElement(q"{Ge}", q"{锗}", 32);
			case 32: return ChemicalElement(q"{As}", q"{砷}", 33);
			case 33: return ChemicalElement(q"{Se}", q"{硒}", 34);
			case 34: return ChemicalElement(q"{Br}", q"{溴}", 35);
			case 35: return ChemicalElement(q"{Kr}", q"{氪}", 36);
			case 36: return ChemicalElement(q"{Rb}", q"{铷}", 37);
			case 37: return ChemicalElement(q"{Sr}", q"{锶}", 38);
			case 38: return ChemicalElement(q"{Y}", q"{钇}", 39);
			case 39: return ChemicalElement(q"{Zr}", q"{锆}", 40);
			case 40: return ChemicalElement(q"{Nb}", q"{铌}", 41);
			case 41: return ChemicalElement(q"{Mo}", q"{钼}", 42);
			case 42: return ChemicalElement(q"{Tc}", q"{Technetium}", 43);
			case 43: return ChemicalElement(q"{Ru}", q"{锝}", 44);
			case 44: return ChemicalElement(q"{Rh}", q"{锝}", 45);
			case 45: return ChemicalElement(q"{Pd}", q"{钯}", 46);
			case 46: return ChemicalElement(q"{Ag}", q"{银}", 47);
			case 47: return ChemicalElement(q"{Cd}", q"{镉}", 48);
			case 48: return ChemicalElement(q"{In}", q"{铟}", 49);
			case 49: return ChemicalElement(q"{Sn}", q"{锡}", 50);
			case 50: return ChemicalElement(q"{Sb}", q"{锑}", 51);
			case 51: return ChemicalElement(q"{Te}", q"{碲}", 52);
			case 52: return ChemicalElement(q"{I}", q"{碘}", 53);
			case 53: return ChemicalElement(q"{Xe}", q"{氙}", 54);
			case 54: return ChemicalElement(q"{Cs}", q"{铯}", 55);
			case 55: return ChemicalElement(q"{Ba}", q"{钡}", 56);
			case 56: return ChemicalElement(q"{La}", q"{镧}", 57);
			case 57: return ChemicalElement(q"{Ce}", q"{铈}", 58);
			case 58: return ChemicalElement(q"{Pr}", q"{镨}", 59);
			case 59: return ChemicalElement(q"{Nd}", q"{钕}", 60);
			case 60: return ChemicalElement(q"{Pm}", q"{钷}", 61);
			case 61: return ChemicalElement(q"{Sm}", q"{钐}", 62);
			case 62: return ChemicalElement(q"{Eu}", q"{铕}", 63);
			case 63: return ChemicalElement(q"{Gd}", q"{钆}", 64);
			case 64: return ChemicalElement(q"{Tb}", q"{铽}", 65);
			case 65: return ChemicalElement(q"{Dy}", q"{钬}", 66);
			case 66: return ChemicalElement(q"{Ho}", q"{钬}", 67);
			case 67: return ChemicalElement(q"{Er}", q"{铥}", 68);
			case 68: return ChemicalElement(q"{Tm}", q"{铥}", 69);
			case 69: return ChemicalElement(q"{Yb}", q"{镱}", 70);
			case 70: return ChemicalElement(q"{Lu}", q"{镥}", 71);
			case 71: return ChemicalElement(q"{Hf}", q"{铪}", 72);
			case 72: return ChemicalElement(q"{Ta}", q"{钽}", 73);
			case 73: return ChemicalElement(q"{W}", q"{钨}", 74);
			case 74: return ChemicalElement(q"{Re}", q"{铼}", 75);
			case 75: return ChemicalElement(q"{Os}", q"{锇}", 76);
			case 76: return ChemicalElement(q"{Ir}", q"{铱}", 77);
			case 77: return ChemicalElement(q"{Pt}", q"{铂}", 78);
			case 78: return ChemicalElement(q"{Au}", q"{金}", 79);
			case 79: return ChemicalElement(q"{Hg}", q"{汞}", 80);
			case 80: return ChemicalElement(q"{Tl}", q"{铊}", 81);
			case 81: return ChemicalElement(q"{Pb}", q"{铅}", 82);
			case 82: return ChemicalElement(q"{Bi}", q"{铋}", 83);
			case 83: return ChemicalElement(q"{Po}", q"{钋}", 84);
			case 84: return ChemicalElement(q"{At}", q"{砹}", 85);
			case 85: return ChemicalElement(q"{Rn}", q"{氡}", 86);
			case 86: return ChemicalElement(q"{Fr}", q"{钫}", 87);
			case 87: return ChemicalElement(q"{Ra}", q"{镭}", 88);
			case 88: return ChemicalElement(q"{Ac}", q"{锕}", 89);
			case 89: return ChemicalElement(q"{Th}", q"{钍}", 90);
			case 90: return ChemicalElement(q"{Pa}", q"{镎}", 91);
			case 91: return ChemicalElement(q"{U}", q"{镎}", 92);
			case 92: return ChemicalElement(q"{Np}", q"{镎}", 93);
			case 93: return ChemicalElement(q"{Pu}", q"{钚}", 94);
			case 94: return ChemicalElement(q"{Am}", q"{镅}", 95);
			case 95: return ChemicalElement(q"{Cm}", q"{锔}", 96);
			case 96: return ChemicalElement(q"{Bk}", q"{锫}", 97);
			case 97: return ChemicalElement(q"{Cf}", q"{锎}", 98);
			case 98: return ChemicalElement(q"{Es}", q"{锿}", 99);
			case 99: return ChemicalElement(q"{Fm}", q"{镄}", 100);
			case 100: return ChemicalElement(q"{Md}", q"{钔}", 101);
			case 101: return ChemicalElement(q"{No}", q"{锘}", 102);
			case 102: return ChemicalElement(q"{Lr}", q"{铹}", 103);
			case 103: return ChemicalElement(q"{Rf}", q"{𬬻}", 104);
			case 104: return ChemicalElement(q"{Db}", q"{𬭊}", 105);
			case 105: return ChemicalElement(q"{Sg}", q"{𬭳}", 106);
			case 106: return ChemicalElement(q"{Bh}", q"{𬭛}", 107);
			case 107: return ChemicalElement(q"{Hs}", q"{𬭶}", 108);
			case 108: return ChemicalElement(q"{Mt}", q"{鿏}", 109);
			case 109: return ChemicalElement(q"{Ds}", q"{𫟼}", 110);
			case 110: return ChemicalElement(q"{Rg}", q"{𬬭}", 111);
			case 111: return ChemicalElement(q"{Cn}", q"{鿔}", 112);
			case 112: return ChemicalElement(q"{Nh}", q"{鿭}", 113);
			case 113: return ChemicalElement(q"{Fl}", q"{𫓧}", 114);
			case 114: return ChemicalElement(q"{Mc}", q"{镆}", 115);
	...
	override ChemicalUnit scienceUnit() {
		final switch(uniform(0, 29, this.rnd)) {
			...
			case 3: return ChemicalUnit(q"{安培}", q"{A}");
			case 4: return ChemicalUnit(q"{开尔文}", q"{K}");
			case 5: return ChemicalUnit(q"{坎德拉}", q"{cd}");
			case 6: return ChemicalUnit(q"{千克}", q"{kg}");
			case 7: return ChemicalUnit(q"{弧度}", q"{rad}");
			case 8: return ChemicalUnit(q"{赫兹}", q"{Hz}");
			case 9: return ChemicalUnit(q"{牛顿}", q"{N}");
			case 10: return ChemicalUnit(q"{帕斯卡}", q"{Pa}");
			case 11: return ChemicalUnit(q"{焦耳}", q"{J}");
			case 12: return ChemicalUnit(q"{瓦特}", q"{W}");
			case 13: return ChemicalUnit(q"{库伦}", q"{C}");
			case 14: return ChemicalUnit(q"{伏特}", q"{V}");
			case 15: return ChemicalUnit(q"{欧姆}", q"{Ω}");
			case 16: return ChemicalUnit(q"{特斯拉}", q"{T}");
			case 17: return ChemicalUnit(q"{摄氏度}", q"{°C}");
			case 18: return ChemicalUnit(q"{流明}", q"{lm}");
			case 19: return ChemicalUnit(q"{贝尔勒尔}", q"{Bq}");
			case 20: return ChemicalUnit(q"{戈瑞}", q"{Gy}");
			case 21: return ChemicalUnit(q"{希沃特}", q"{Sv}");
			case 22: return ChemicalUnit(q"{球面度}", q"{sr}");
			case 23: return ChemicalUnit(q"{法拉}", q"{F}");
			case 24: return ChemicalUnit(q"{西门子}", q"{S}");
			case 25: return ChemicalUnit(q"{韦伯}", q"{Wb}");
